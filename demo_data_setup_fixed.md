# ✅ DEMO DATA SETUP - AUTO-GENERATED UUIDs (FIXED VERSION)

**This version automatically generates UUIDs - just copy & paste!**
...
INSERT INTO public.students (user_id, student_number, corp_email, full_name, birthdate, sex, address, personal_email, phone, course_id, year_level, last_school, strand, year_graduated, enrollment_status, is_active)
SELECT u.id, 'PSU-2024-001', 'juan.delacruz@psu.edu.ph', u.full_name, '2005-03-15', 'Male', '123 Main St, Palawan', 'juan.personal@email.com', '09123456789', c.id, '1st Year', 'Palawan National High School', 'STEM', '2023', 'active', true
...
INSERT INTO public.students (user_id, student_number, corp_email, full_name, birthdate, sex, address, personal_email, phone, course_id, year_level, last_school, strand, year_graduated, enrollment_status, is_active)
SELECT u.id, 'PSU-2024-002', 'maria.garcia@psu.edu.ph', u.full_name, '2005-07-22', 'Female', '456 Oak Ave, Palawan', 'maria.personal@email.com', '09198765432', c.id, '1st Year', 'Santo Nino High School', 'STEM', '2023', 'active', true
FROM users u, courses c
...
**Solution:** The data already exists. Just run the next test commands to verify.

### Error: "invalid input syntax for type uuid"
**Solution:** Don't use this - it means your database has the old SQL format. Use this file instead!

### Error: "relation does not exist"
**Solution:** Make sure the database schema is created first. Run `supabase_schema.sql` before running this.
...
**This version has NO placeholder UUIDs - everything auto-generates!** ✅
